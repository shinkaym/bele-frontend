...
import { customerFieldOptions, customerSortByOptions, customerStatus, sortOrderOptions } from '@/constants'
      ...
      <div className='flex flex-col gap-10'>
        <div className='rounded-sm border bg-white px-5 pt-6 pb-2.5 shadow-default dark:bg-boxdark'>
          <div className='flex items-center justify-between gap-5 mb-6'>
            ...
            {/* <Button type='link' to='/tables/customer/add' size='sm'>
              Add
            </Button> */}
          </div>
          {loading ? (
            ...
            <CustomerTable customers={customers} onRefresh={() => fetchData(pagination.currentPage, 5)} />
          )}
          <Pagination
