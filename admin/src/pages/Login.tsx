...
import DarkModeSwitcher from '@/components/layout/Partials/Header/DarkModeSwitcher'
  ...
  return (
    <>
      <div className='h-screen w-screen'>
        <div className='rounded-sm border bg-white border-stroke shadow-default dark:border-strokedark dark:bg-boxdark h-full'>
          <div className='flex flex-wrap items-center'>
            <div className='hidden w-full xl:block xl:w-1/2'>
              <div className='py-17.5 px-26 text-center'>
                <h1 className='2xl:px-20 text-2xl font-bold'>Best Choice For Good Styles</h1>
            ...
            <div className='w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2'>
              <div className='w-full p-4 sm:p-12.5 xl:p-17.5'>
                <ul className='flex items-center justify-between mb-1.5'>
                  <li className='font-medium'>Let started</li>
                  <DarkModeSwitcher />
                </ul>
                <h2 className='mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2'>
                  Sign In to Bele Admin
                </h2>
