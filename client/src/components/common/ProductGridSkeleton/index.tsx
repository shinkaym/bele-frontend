...
const ProductGridSkeleton = ({className = 'lg:min-h-80 md:min-h-64 sm:min-h-56 min-h-48'}:ProductGridSkeletonProps) => {
  return (
    <>
      <div className={`space-y-1 animate-pulse`}>
        <div className={`relative group transition-all  duration-500 ease-linear overflow-hidden w-full bg-slate-200 ${className}`}></div>
