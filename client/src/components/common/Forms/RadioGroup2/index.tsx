...
const RadioGroup2 = (
  { options, name, selectedValue, onChange, className, layout = 'vertical', label }: RadioGroup2Props,
...
const ForwardedRadioGroup2 = React.forwardRef(RadioGroup2)
ForwardedRadioGroup2.displayName = 'RadioGroup2'

export default ForwardedRadioGroup2